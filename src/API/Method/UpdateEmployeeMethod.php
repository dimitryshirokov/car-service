...
/**
 * Class UpdateEmployeeMethod
 * @package App\API\Method
 */
class UpdateEmployeeMethod implements Procedure
{
    /**
    ...
    /**
     * UpdateEmployeeMethod constructor.
    ...
    public function __invoke(Request $request): Response
    {
        ...
        try {
            $employee = $this->getEmployeeService()->update($params, $params['id']);
